...
public class IMDBStudent20180976
{
        ...
        /*public static class TopKMapper extends Mapper<LongWritable, Text, Text, NullWritable>           // topK map
        {
...
while( queue.size() != 0 )
        ...
        public static void main(String[] args) throws Exception
        {
                ...
                int topK;
                String firstOutput = "output_join";

                if (otherArgs.length != 3) {
                        System.err.println("Usage: IMDB <in> <out>"); System.exit(2);
                }
