...
//    ResultReceiver 에게 결과를 Bundle 형태로 전달
    private void deliverResultToReceiver(int resultCode, ArrayList<LatLng> message) {
        ...
        // message가 ArrayList<LatLng> 형태라 putSerializable 사용
        bundle.putSerializable(Constants.RESULT_DATA_KEY, message); // Constants.RESULT_DATA_KEY는 message 구별 할 key 값
        // 리시버에 resultCode랑 메세지 담은 bundle 전달 => MainActivity의 LatLngResultReceiver 메소드로 전달됨
